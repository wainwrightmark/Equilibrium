...
//                position = new Vector2(5.971687316894531e+00f, -8.106019020080566e+00f),
//                angle = 0,
...
//                position = new Vector2(5.426122665405273e+00f, -6.587452411651611e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//                    restitution = 8.000000119209290e-01f,
//                    density = 9.999999776482582e-03f,
//                    isSensor = false,
//                    filter =
//                        {
//                            categoryBits = 1,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(6.150398731231689e+00f, -6.973721504211426e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.491883754730225e+00f, -5.986517429351807e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.960605621337891e+00f, -6.547102928161621e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.951690673828125e+00f, -6.028742790222168e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.928072929382324e+00f, -5.287778377532959e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.825547695159912e+00f, -7.672395706176758e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.955581188201904e+00f, -6.287708759307861e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(6.395890712738037e+00f, -5.987843513488770e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.947129249572754e+00f, -5.753320217132568e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.924207210540771e+00f, -5.488777160644531e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.795244693756104e+00f, -6.978021621704102e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(6.166951179504395e+00f, -7.688251495361328e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(6.447659015655518e+00f, -6.578778743743896e+00f),
//                angle = -3.138845443725586e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(-9.962106704711914e+00f, -5.336883068084717e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//                var fd = new FixtureDef
//                {
//                    friction = 2.000000029802322e-01f,
//                    restitution = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(7.153423309326172e+00f, 1.670340776443481e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//                    friction = 0,
//                    restitution = 0,
//                    density = 2.000000000000000e+00f,
//                    isSensor = false,
//                    filter =
//                        {
//                            categoryBits = 1,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.183950233459473e+01f, 3.602335691452026e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//                {
//                    friction = 2.000000029802322e-01f,
//                    restitution = 2.000000029802322e-01f,
//                    density = 1.000000000000000e+00f,
//                    isSensor = false,
//                    filter =
//                        {
...
//                vs[2] = new Vector2(4.565430396770254e-41f, 0);
//                vs[3] = new Vector2(0, 1.216642260551453e-01f);
...
//                var fd = new FixtureDef
//                {
//                    friction = 8.000000119209290e-01f,
//                    restitution = 0,
//                    density = 0,
//                    isSensor = false,
//                    filter =
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(-3.580528497695923e-02f, -7.826317548751831e-01f),
//                angle = 8.054048418998718e-01f,
//                linearVelocity = new Vector2(-2.581855468451977e-02f, 0),
//                angularVelocity = 5.164637044072151e-02f,
//                linearDamping = 0,
//                angularDamping = 0,
//                allowSleep = true,
//                awake = true,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(8.139089584350586e+00f, -1.215644359588623e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//                    friction = 0,
//                    restitution = 8.000000119209290e-01f,
//                    density = 2.000000029802322e-01f,
//                    isSensor = false,
//                    filter =
//                        {
//                            categoryBits = 1,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.655718612670898e+01f, 6.269404888153076e-01f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(17.9f, 5.424887180328369e+00f),
//                angle = 4.814267158508301e-03f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.078072738647461e+01f, 3.009121179580688e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(-2.771063446998596e-01f, -1.387045264244080e+00f),
//                angle = 2.316761016845703e-02f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(8.646305799484253e-01f, 5.665562152862549e+00f),
//                angle = -7.091794908046722e-02f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(-4.321518898010254e+00f, 1.640526008605957e+01f),
//                angle = 8.054048418998718e-01f,
//                linearVelocity = new Vector2(-2.581855468451977e-02f, 0),
//                angularVelocity = 5.164637044072151e-02f,
//                linearDamping = 0,
...
//                    friction = 2.000000029802322e-01f,
//                    restitution = 2.000000029802322e-01f,
//                    density = 1.000000000000000e+01f,
//                    isSensor = false,
//                    filter =
//                        {
//                            categoryBits = 1,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.574825096130371e+01f, 3.597975730895996e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.678366470336914e+01f, 3.597975730895996e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.352297210693359e+01f, 7.127127051353455e-02f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.248203182220459e+01f, 7.127127051353455e-02f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(5.670880794525146e+00f, 5.606304168701172e+00f),
//                angle = 6.462279510498047e+01f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//                    friction = 2.000000029802322e-01f,
//                    restitution = 2.000000029802322e-01f,
//                    density = 6.000000238418579e-01f,
//                    isSensor = false,
//                    filter =
//                        {
//                            categoryBits = 1,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.079027271270752e+01f, 7.081282138824463e+00f),
//                angle = 1.589920759201050e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.559602928161621e+01f, 7.127127051353455e-02f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(8.146527290344238e+00f, 8.603442192077637e+00f),
//                angle = 1.590483069419861e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.144438743591309e+01f, 7.127127051353455e-02f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.810375213623047e+01f, 6.631551742553711e+00f),
//                angle = 6.462279510498047e+01f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//                    friction = 2.000000029802322e-01f,
//                    restitution = 2.000000029802322e-01f,
//                    density = 1.000000014901161e-01f,
//                    isSensor = false,
//                    filter =
//                        {
//                            categoryBits = 1,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.867184638977051e+01f, 1.818919181823730e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.761596107482910e+01f, 1.220154881477356e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.873267364501953e+01f, 5.134416103363037e+00f),
//                angle = 1.099908113479614e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(-6.535434722900391e-01f, -1.142022252082825e+00f),
//                angle = -1.570796251296997e+00f,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
//                angularDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.455838489532471e+01f, 7.127127051353455e-02f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.470820426940918e+01f, 3.597976446151733e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(2.275662994384766e+01f, 3.592880964279175e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//            {
//                type = BodyType.Dynamic,
//                position = new Vector2(1.972773170471191e+01f, 2.411245346069336e+00f),
//                angle = 0,
//                linearVelocity = new Vector2(0, 0),
//                angularVelocity = 0,
//                linearDamping = 0,
...
//                localAnchorA = new Vector2(-1.419764943420887e-02f, 3.472273647785187e-01f),
//                localAnchorB = new Vector2(1.419764943420887e-02f, -3.472273647785187e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
//                enableMotor = false,
//                motorSpeed = 0,
//                maxMotorTorque = 0
//            };
...
//                bodyB = bodies[3],
//                collideConnected = false,
//                localAnchorA = new Vector2(3.915640115737915e-01f, -6.454584002494812e-02f),
//                localAnchorB = new Vector2(-6.432041525840759e-02f, -2.964915335178375e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[8],
//                collideConnected = false,
//                localAnchorA = new Vector2(-1.589771127328277e-03f, 1.294880807399750e-01f),
//                localAnchorB = new Vector2(1.589295570738614e-03f, -1.294876039028168e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[13],
//                collideConnected = false,
//                localAnchorA = new Vector2(-7.294950541108847e-03f, 3.572863936424255e-01f),
//                localAnchorB = new Vector2(7.294473703950644e-03f, -3.572863936424255e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[9],
//                collideConnected = false,
//                localAnchorA = new Vector2(-3.627054393291473e-01f, -6.571095436811447e-02f),
//                localAnchorB = new Vector2(8.541004359722137e-02f, -3.014662265777588e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[2],
//                collideConnected = false,
//                localAnchorA = new Vector2(-1.804183274507523e-01f, 1.079236492514610e-01f),
//                localAnchorB = new Vector2(8.202061988413334e-03f, -3.192147314548492e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[11],
//                collideConnected = false,
//                localAnchorA = new Vector2(8.363898377865553e-04f, 1.560461223125458e-01f),
//                localAnchorB = new Vector2(-3.581499680876732e-03f, -4.494129493832588e-02f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[1],
//                collideConnected = false,
//                localAnchorA = new Vector2(7.003130018711090e-02f, 2.955459952354431e-01f),
//                localAnchorB = new Vector2(2.619568957015872e-03f, -3.052060604095459e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[5],
//                collideConnected = false,
//                localAnchorA = new Vector2(-2.784118754789233e-03f, 1.501919031143188e-01f),
//                localAnchorB = new Vector2(1.020645722746849e-03f, -1.252421736717224e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[12],
//                collideConnected = false,
//                localAnchorA = new Vector2(1.821715533733368e-01f, 1.166393160820007e-01f),
//                localAnchorB = new Vector2(1.562742702662945e-02f, -3.138234615325928e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[4],
//                collideConnected = false,
//                localAnchorA = new Vector2(-2.156140282750130e-03f, 1.297037452459335e-01f),
//                localAnchorB = new Vector2(2.155664609745145e-03f, -1.297032535076141e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[10],
//                collideConnected = false,
//                localAnchorA = new Vector2(3.814474985119887e-05f, 9.424854815006256e-02f),
//                localAnchorB = new Vector2(2.223334275186062e-02f, -1.703564822673798e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[14],
//                collideConnected = false,
//                localAnchorA = new Vector2(-4.893289506435394e-02f, 2.880721986293793e-01f),
//                localAnchorB = new Vector2(1.211793627589941e-03f, -3.030030131340027e-01f),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerAngle = -8.726646006107330e-02f,
//                upperAngle = 8.726646006107330e-02f,
...
//                bodyB = bodies[40],
//                collideConnected = false,
//                localAnchorA = new Vector2(2.873267364501953e+01f, 5.134416103363037e+00f),
...
//                bodyB = bodies[41],
//                collideConnected = false,
//                localAnchorA = new Vector2(-6.608279347419739e-01f, -8.509724140167236e-01f),
//                localAnchorB = new Vector2(-2.910498380661011e-01f, -7.284440565854311e-03f),
//                referenceAngle = 0,
//                enableLimit = false,
//                lowerAngle = 0,
//                upperAngle = 0,
...
//                bodyB = bodies[19],
//                collideConnected = false,
//                localAnchorA = new Vector2(4.595311164855957e+00f, -1.409123420715332e+00f),
//                localAnchorB = new Vector2(4.783708136528730e-03f, 9.254086180590093e-04f),
//                length = 4.671227455139160e+00f,
//                frequencyHz = 0,
//                dampingRatio = 0
//            };
...
//                localAnchorA = new Vector2(1.085271549224854e+01f, 5.685722351074219e+00f),
//                localAnchorB = new Vector2(-1.397351622581482e+00f, -8.028738200664520e-02f),
//                referenceAngle = 0,
//                enableLimit = false,
//                lowerAngle = 0,
//                upperAngle = 0,
...
//                bodyB = bodies[24],
//                collideConnected = false,
//                localAnchorA = new Vector2(2.482175827026367e-01f, -1.928825047798455e-03f),
//                localAnchorB = new Vector2(-3.783383965492249e-01f, 5.571336951106787e-03f),
//                referenceAngle = 0,
//                enableLimit = false,
//                lowerAngle = 0,
//                upperAngle = 0,
...
//                bodyB = bodies[16],
//                collideConnected = false,
//                localAnchorA = new Vector2(7.153423309326172e+00f, 1.670340776443481e+00f),
//                localAnchorB = new Vector2(0, 0),
//                referenceAngle = 0,
//                enableLimit = false,
//                lowerAngle = 0,
...
//                bodyB = bodies[20],
//                collideConnected = false,
//                localAnchorA = new Vector2(8.139089584350586e+00f, -1.215644359588623e+00f),
//                localAnchorB = new Vector2(1.000000000000000e+00f, 0),
//                localAxisA = new Vector2(1.000000000000000e+00f, 0),
//                referenceAngle = 0,
//                enableLimit = true,
//                lowerTranslation = -6.154879093170166e+00f,
//                upperTranslation = 1.008777618408203e+00f,
//                enableMotor = false,
//                motorSpeed = 0,
//                maxMotorForce = 0
//            };
...
//                bodyB = bodies[26],
//                collideConnected = true,
//                localAnchorA = new Vector2(1.495088100433350e+00f, 5.568014621734619e+00f),
//                localAnchorB = new Vector2(6.357848644256592e-01f, -5.262904614210129e-02f),
//                referenceAngle = 0,
//                enableLimit = false,
//                lowerAngle = 0,
//                upperAngle = 0,
